    ...
    <div className="min-h-screen bg-background bg-grid-pattern text-foreground font-display selection:bg-primary/30">
      <main className="relative max-w-lg mx-auto min-h-screen pb-24 shadow-2xl bg-background/80 backdrop-blur-xl border-x border-border">
        ...
        <section className="relative h-72 overflow-hidden">
          ...
          >
            <div className="absolute inset-0 bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1503387762-592deb58ef4e?q=80&w=1200&auto=format&fit=crop')] mt-32" />
        ...
        <div className="px-6 -mt-8 relative z-20 space-y-10">
          ...
          <header className="flex justify-between items-center mb-10 bg-card/50 backdrop-blur-md border border-border p-4 rounded-3xl shadow-lg">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20 p-2 overflow-hidden">
          ...
          <section className="space-y-4">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide snap-x">
              {adventures.map((adv) => (
                ...
                >
                  <img src={adv.img} className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" alt={adv.label} />
          ...
          <motion.div 
            ...
            title="Iniciar Nueva Cubicación"
