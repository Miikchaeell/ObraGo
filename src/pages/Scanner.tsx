        ...
        {step === 'confirm' && (
            <div className="py-8 space-y-6 pb-32">
                ...
                <div className="bg-white/5 p-8 rounded-[40px] border border-white/10 space-y-6">
                    ...
                    <Button onClick={()=>exportPDF()} className="w-full h-16 bg-black text-primary font-black uppercase rounded-2xl flex gap-3 shadow-xl"><Download /> Descargar PDF Élite</Button>
                </div>
